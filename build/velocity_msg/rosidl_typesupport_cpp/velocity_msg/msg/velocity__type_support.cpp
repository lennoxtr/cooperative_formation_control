...
static const _Velocity_type_support_symbol_names_t _Velocity_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, velocity_msg, msg, Velocity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, velocity_msg, msg, Velocity)),
  }
};
...
{
  return &::velocity_msg::msg::rosidl_typesupport_cpp::Velocity_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, velocity_msg, msg, Velocity)() {
  return get_message_type_support_handle<velocity_msg::msg::Velocity>();
}
