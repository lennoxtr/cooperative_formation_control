...
bool velocity_msg__msg__velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("velocity_msg.msg._velocity.Velocity", full_classname_dest, 35) == 0);
  }
  velocity_msg__msg__Velocity * ros_message = _ros_message;
  {  // robot_id
...
PyObject * velocity_msg__msg__velocity__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("velocity_msg.msg._velocity");
