...
static const _Heading_type_support_symbol_names_t _Heading_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, heading_msg, msg, Heading)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, heading_msg, msg, Heading)),
  }
};
...
{
  return &::heading_msg::msg::rosidl_typesupport_cpp::Heading_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, heading_msg, msg, Heading)() {
  return get_message_type_support_handle<heading_msg::msg::Heading>();
}
