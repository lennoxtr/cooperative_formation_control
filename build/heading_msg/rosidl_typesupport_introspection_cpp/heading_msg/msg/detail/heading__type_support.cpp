...
{
  new (message_memory) heading_msg::msg::Heading(_init);
}

void Heading_fini_function(void * message_memory)
{
  auto typed_message = static_cast<heading_msg::msg::Heading *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Heading_message_member_array[2] = {
  {
    ...
    offsetof(heading_msg::msg::Heading, robot_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(heading_msg::msg::Heading, heading),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Heading_message_members = {
  "heading_msg::msg",  // message namespace
  "Heading",  // message name
  2,  // number of fields
  sizeof(heading_msg::msg::Heading),
...
{
  return &::heading_msg::msg::rosidl_typesupport_introspection_cpp::Heading_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, heading_msg, msg, Heading)() {
  return &::heading_msg::msg::rosidl_typesupport_introspection_cpp::Heading_message_type_support_handle;
}
